...
OUTPUT=$(uv run pytest tests/unit/ -q --tb=no -n 6 --dist=loadscope --deselect tests/unit/interfaces/mcp_server_tests/test_tools.py::TestRegisterTools::test_registers_all_17_tools 2>&1)
EXIT_CODE=$?
