...
- `/fork-prune-sessions 7` - Eliminar mayores a 7 días
- `/fork-prune-sessions 60` - Eliminar mayores a 60 días
- `/fork-prune-sessions --dry-run` - Solo mostrar, no eliminar
- `/fork-prune-sessions --all` - Eliminar todos menos el último
