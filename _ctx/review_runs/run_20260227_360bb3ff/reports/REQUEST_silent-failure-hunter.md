# Agent Handoff Request: silent-failure-hunter

## Run Information
- **Run ID**: run_20260227_360bb3ff
- **Branch**: review/main-cf401c1f
- **Base Branch**: main
- **Timestamp**: 2026-02-27T21:39:34.781Z
...
```bash
reviewctl ingest --agent silent-failure-hunter --input <report-file.md>
```

Or pipe directly:

```bash
cat <<'EOF' | reviewctl ingest --agent silent-failure-hunter
