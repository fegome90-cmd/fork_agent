...
STOPWORDS = {
    "the", "a", "an", "is", "are", "do", "does", "how", "why", "where", "when",
    "what", "should", "than", "from", "for", "to", "of", "in", "on", "be",
    "i", "we", "you", "it", "or", "and", "after", "before", "with", "without",
    "el", "la", "los", "las", "de", "del", "que", "como", "por", "para",
    "cuando", "donde", "si", "un", "una", "y", "o", "instead",
}

_DOMAIN_TERMS = {
    "fts5", "sqlite", "openclaw", "status", "stability", "docs", "memory", "api",
    "cli", "pi", "gemini", "claude",
}
