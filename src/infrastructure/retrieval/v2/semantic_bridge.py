...
RETRIEVAL_BRIDGES: dict[str, dict[str, list[str]]] = {
    "ebea61a6-00a2-4efe-8a50-f2b4bfba25bd": {
        ...
        "concept_keywords": [
            "fork", "session", "sessions", "create", "created", "creation",
            "endpoint", "POST", "route", "API", "agents", "localhost",
        ],
        "natural_phrasings": [
    ...
    "8cf4838a-1458-4483-bb2a-0bf4113a143a": {
        ...
        "concept_keywords": [
            "archive", "memory", "pilot", "keep", "delete", "historical",
            "raw", "diary", "migrate", "lot", "validation",
        ],
        "natural_phrasings": [
    ...
    "77e8384a-793d-4906-8fd1-a1e2039cbaf5": {
        ...
        "concept_keywords": [
            "observation", "update", "replace", "supersede", "lifecycle",
            "refine", "change", "version", "topic", "same", "different",
        ],
        "natural_phrasings": [
    ...
    "94e7ac8e-9272-4981-b747-df092703d43c": {
        ...
        "concept_keywords": [
            "status", "stability", "wins", "precedence", "retrieve", "retrieval",
            "active", "stable", "unstable", "priority", "degrade",
        ],
        "natural_phrasings": [
    ...
    "6c94a28c-2565-4923-8d15-628eff14ac53": {
        ...
        "concept_keywords": [
            "fallback", "contract", "explicit", "silent", "failure", "tool",
            "integration", "trigger", "alternative", "behavior", "document",
        ],
        "natural_phrasings": [
    ...
    "2547eb47-4824-42bf-82a5-a2c397a84b08": {
        ...
        "concept_keywords": [
            "branch", "review", "workflow", "cli", "command", "start",
            "kick", "off", "init", "procedure",
        ],
        "natural_phrasings": [
    ...
    "f8f2c14d-3e9c-4e3a-b119-4cf8e1c6fc27": {
        ...
        "concept_keywords": [
            "performance", "speed", "rate", "faster", "workers", "gemini",
            "claude", "rate", "limiting", "direct", "cli",
        ],
        "natural_phrasings": [
    ...
    "cd34a8c8-8ac4-4330-80de-9bb1c0cf3287": {
        ...
        "concept_keywords": [
            "underscores", "hyphens", "paths", "convert", "replace",
            "bug", "claude-session-driver",
        ],
        "natural_phrasings": [
    ...
    "e29b1278-9de4-4f75-b19e-4a5878a56b0c": {
        ...
        "concept_keywords": [
            "official", "guidance", "memory", "notes", "precedence",
            "beat", "priority", "intent", "based",
        ],
        "natural_phrasings": [
    ...
    "984f0285-593e-44e5-ac09-c97955b2173a": {
        ...
        "concept_keywords": [
            "sqlite", "fts5", "stack", "backend", "configured", "openclaw",
            "retrieval", "memory",
        ],
        "natural_phrasings": [
