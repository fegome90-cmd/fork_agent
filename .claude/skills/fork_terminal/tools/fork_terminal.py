...
def fork_terminal(command: str) -> str:
    ...
    if system == "Darwin":  # macOS
        ...
        if shutil.which("tmux"):
            ...
            subprocess.run(["tmux", "new-session", "-d", "-s", session_name, f"{command}; read -p 'Press enter to close...'"])
        ...
        raise NotImplementedError("This function is only implemented for macOS, Windows, and Linux.")
